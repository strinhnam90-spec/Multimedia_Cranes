...
static constexpr auto qt_meta_stringdata_ZN10NewsWidgetE = QtMocHelpers::stringData(
    "NewsWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10NewsWidgetE[] = {
...
Q_CONSTINIT const QMetaObject NewsWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10NewsWidgetE.offsetsAndSizes,
    qt_meta_data_ZN10NewsWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10NewsWidgetE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<NewsWidget, std::true_type>
    >,
    nullptr
} };
...
void *NewsWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10NewsWidgetE.stringdata0))
