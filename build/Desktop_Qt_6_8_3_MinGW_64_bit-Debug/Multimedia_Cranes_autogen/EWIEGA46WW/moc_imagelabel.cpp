...
static constexpr auto qt_meta_stringdata_ZN10ImageLabelE = QtMocHelpers::stringData(
    "ImageLabel"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10ImageLabelE[] = {
...
Q_CONSTINIT const QMetaObject ImageLabel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10ImageLabelE.offsetsAndSizes,
    qt_meta_data_ZN10ImageLabelE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10ImageLabelE_t,
        // Q_OBJECT / Q_GADGET
...
void *ImageLabel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10ImageLabelE.stringdata0))
