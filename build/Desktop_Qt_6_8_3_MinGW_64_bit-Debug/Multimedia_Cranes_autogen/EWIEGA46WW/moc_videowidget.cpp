...
static constexpr auto qt_meta_stringdata_ZN11VideoWidgetE = QtMocHelpers::stringData(
    "VideoWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11VideoWidgetE[] = {
...
Q_CONSTINIT const QMetaObject VideoWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11VideoWidgetE.offsetsAndSizes,
    qt_meta_data_ZN11VideoWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11VideoWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void *VideoWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11VideoWidgetE.stringdata0))
